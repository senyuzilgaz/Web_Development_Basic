<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="SP_CRUD._Default" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="nav-justified">
        <tr>
            <td class="modal-lg" style="font-size: x-large; font-family: Arial, Helvetica, sans-serif; color: #000000; font-weight: bold; width: 565px; padding-top: 50px;">Complete CRUD Operation in Asp.Net with MSSQL Using Stored Procedure</td>
            <td>&nbsp;</td>
        </tr>
        <tr>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
        ...
        <tr>
            ...
            <td style="height: 43px">
                <asp:Button ID="Button1" runat="server" BackColor="#FF3300" BorderStyle="None" CssClass="btn btn-primary" Font-Size="Medium" ForeColor="White" Text="Insert" OnClick="Button1_Click1" />
            &nbsp;&nbsp;&nbsp;
                <asp:Button ID="Button2" runat="server" BackColor="#FF3300" BorderStyle="None" CssClass="btn btn-primary" Font-Size="Medium" ForeColor="White" Text="Update" OnClick="Button1_Click2" />
            &nbsp;&nbsp;&nbsp;
                <asp:Button ID="Button3" runat="server" BackColor="#FF3300" BorderStyle="None" CssClass="btn btn-primary" Font-Size="Medium" ForeColor="White" Text="Delete" OnClick="Button1_Click3" OnClientClick="return confirm('Are you sure to delete?');" />
            </td>
        </tr>
        <tr>
