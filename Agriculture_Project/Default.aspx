<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Default.aspx.vb" Inherits="Agriculture_Project._Default" %>
            ...
            <ItemTemplate>
                <div class="container py-lg-5">
                    <div class="text-center">
                        ...
                        <p class="main_p mt-4 mb-4 pt-2 text-center mx-auto"> <%# Eval("Decription_TB") %></p>
                    </div>
                </div>
            </ItemTemplate>
        </asp:Repeater>
